...
import kedar.com.websockets.Constants.POLYGON_CRYPTO_BASE_URL
...
class PolygonCryptoRepo(val context: Context) {
    ...
    private val scarletInstance = Scarlet.Builder()
        .webSocketFactory(OkHttpClient().newWebSocketFactory(POLYGON_CRYPTO_BASE_URL))
        .addMessageAdapterFactory(MoshiMessageAdapter.Factory())
        .addStreamAdapterFactory(RxJava2StreamAdapterFactory())


    private lateinit var polygonService: PolygonCryptoService
